...
class Settings:
    ...
    database_path: str = _raw(
        "DATABASE_PATH",
        "/tmp/h1_agent.sqlite3" if os.getenv("VERCEL") else "data/h1_agent.sqlite3",
    )
    ...
    llm_provider: str = _raw("LLM_PROVIDER", "ollama").lower()
    llm_base_url: str = _raw("LLM_BASE_URL", "http://127.0.0.1:11434")
    llm_model: str = _raw("LLM_MODEL", "llama3.1:8b")
